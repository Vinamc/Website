...
<template>
<content>
  <div class="hero min-h-full bg-local" style="background-image: url(./components/img/backrpg.png);">
    <div class="hero-overlay bg-opacity-60"></div>
    <div class="hero-content text-center text-neutral-content">
      <div class="max-w-md">
        <h1 class="mb-5 text-5xl font-bold">Server Minecraft</h1>
        <img class="mb-5 text-5xl font-bold" src="./components/img/logo.png">
  ...
  <div class="hero min-h-full bg-base-200 outline outline-2  outline-offset-2" style="background-color: #08232621;">
    <div class="hero-content flex-col lg:flex-row-reverse">
      <img src="./components/img/2022-03-31-22-11-40.png" class="max-w-sm rounded-lg shadow-2xl" />
      <div>
  ...
  <div class="hero min-h-full bg-base-200">
    <div class="hero-content flex-col lg:flex-row">
      <img src="./components/img/faction.png" class="max-w-sm rounded-lg shadow-2xl" />
      <div>
  ...
  <div class="grid grid-cols-3">
    <div class="card w-100 bg-base-100 shadow-xl">
      <figure class="px-10 pt-10">
        <img src="/icon/lightning-bolt.svg" style="width: 100px" oalt="Shes" class="rounded-xl" />
      </figure>
    ...
    <div class="card w-100 bg-base-100 shadow-xl">
      <figure class="px-10 pt-10">
        <img src="/icon/user-group.svg" style="width: 100px" oalt="Shes" class="rounded-xl" />
      </figure>
      <div class="card-body items-center text-center">
    ...
    <div class="card w-100 bg-base-100 shadow-xl">
      <figure class="px-10 pt-10">
        <img src="/icon//shield-check.svg" style="width: 100px" alt="Shoes" class="rounded-xl" />
      </figure>
      <div class="card-body items-center text-center">
