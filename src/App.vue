...
<template>
  ...
  <div class="navbar bg-base-300 ">
    <div class="navbar-start">
      <img src="./components/img/Asset 1.png" style="width: 300px" class="normal-case" >
    </div>
    <div class="navbar-center hidden lg:flex ">
      <ul class="menu menu-horizontal p-0 ">
        ...
        <li tabindex="0">
          ...
          <ul class="p-2">
            <li style="background-color: #e5e7eb;"><RouterLink to="/rpg">MMO-RPG</RouterLink></li>
            <li style="background-color: #e5e7eb;"><RouterLink to="/" >Faction</RouterLink></li>
            <li style="background-color: #e5e7eb;"><RouterLink to="/">Skyblock</RouterLink></li>
            <li style="background-color: #e5e7eb;"><RouterLink to="/">Prison</RouterLink></li>
          </ul>
        </li>
    ...
    <div class="navbar-end">
      <div class="dropdown dropdown-end">
        ...
        <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
          ...
          <li><a>Chức vụ: Admin</a></li>
          <li><a>Cài đặt</a></li>
          <li><a>V-xu: 10000</a></li>
          <li><a>Đăng xuất</a></li>
        </ul>
      </div>
    </div>
  ...
  <footer class="footer footer-center p-10 bg-primary text-primary-content" style="background-color: #11171e;">
  <div>
    ...
    <p class="font-bold">
      Minecraft Server Vinamc. <br>Nơi khiến bạn phô diễn tất cả kĩ năng
    </p> 
    <p>Design by Nguyễn Quốc Lâm</p>
  </div> 
  <h2>LIÊN HỆ VỚI CHÚNG TÔI <i><a href="mailto:#">HOTRO@VINAMC.VN</a></i></h2>
  <div>
